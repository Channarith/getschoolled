...
EXPECTED_CORPORATE_LESSONS = {
    ...
    "ca-alameda-food-handler-temps": "Safety",
    "ca-alameda-food-handler-contamination": "Safety",
    "ca-alameda-food-handler-cleaning": "Safety",
    "ca-alameda-food-handler-pathogens": "Safety",
    "ca-alameda-food-handler-service": "Safety",
