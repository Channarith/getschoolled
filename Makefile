...
test test-py:
	$(VENV_PY) -m pytest packages/shared/tests packages/sdk/tests services/*/tests apps/agent-runtime/tests apps/webcam-lab/tests training/tests scripts/tests qa/tests -q
...
lint:
	$(VENV_PY) -m ruff check packages/shared/src packages/sdk/src services/*/src apps/webcam-lab/src qa training
