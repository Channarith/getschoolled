...
test test-py:
	$(VENV_PY) -m pytest packages/shared/tests packages/sdk/tests packages/vision-lab/tests services/*/tests apps/agent-runtime/tests training/tests scripts/tests qa/tests -q
