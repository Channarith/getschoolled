...
export const QUESTION_POSITIONS: [number, number][] = [
  ...
  [-25,-8], [0,-25],
  // Extended positions for 60+ questions
  [15,20], [-20,18], [8,-22], [-12,22], [22,-18], [-18,-20],
  [0,25], [25,-12], [-25,10], [18,18], [-15,-18], [12,25],
  [-8,25], [20,22], [-22,20], [28,0], [-28,5], [0,-28],
  [10,10], [-10,-10], [5,-20], [-5,20], [24,8], [-24,-8],
  [14,-24], [-14,24], [20,0], [-20,0], [0,20], [7,26],
  [-7,-26], [26,16], [-26,-16], [11,-11], [-11,11], [23,-23],
  [-23,23], [16,26], [-16,-26], [27,-10],
];
