...
export async function liveRoomPresenceReport(
  roomId: string,
  payload: {
    participantId: string;
    present: boolean;
  ...
  return get(ORCHESTRATOR_URL, `/api/live-rooms/${encodeURIComponent(roomId)}/presence-report`, {
    method: "POST",
    headers: { "content-type": "application/json", ...authHeaders() },
    body: JSON.stringify({
...
export async function explainLangWord(language: string, wordId: string):
  Promise<LangWordExplanation> {
  return get(SPEECH_URL, "/learn/explain-word", {
    method: "POST",
    headers: { "content-type": "application/json" },
...
export async function scoreMusicVideoTranslation(
  ...
  return get(SPEECH_URL, "/learn/music-video/score", {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify({
