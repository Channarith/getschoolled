...
export default function AudioCoursesScreen({ onOpen, initialCategory }: Props) {
  ...
  const listHeader = (
    <View style={styles.headerBlock}>
      ...
      {loading ? (
        <ActivityIndicator color={theme.colors.netflix} style={{ marginVertical: 24 }} />
      ) : null}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  listContent: { paddingHorizontal: theme.spacing.screenX, paddingBottom: 32 },
  headerBlock: { paddingTop: 56 },
  kicker: { ...theme.typography.kicker, color: theme.colors.muted },
  h1: { ...theme.typography.hero, color: theme.colors.text },
  sub: { color: theme.colors.muted, marginBottom: 12, ...theme.typography.body },
  searchWrap: {
  ...
  chipList: { maxHeight: 48, marginBottom: 8 },
  ...
  formatChipText: { color: "#f8fafc", fontWeight: "700", fontSize: 12, maxWidth: 100 },
  formatChipTextOn: { color: "#fff", fontWeight: "800" },
  count: { color: theme.colors.muted, fontSize: 12, marginBottom: 8 },
