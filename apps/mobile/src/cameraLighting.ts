...
/**
 * Browser-only exposure auto-adjust. No-op on React Native (ImagePicker path).
 */
    ...
    case "blocked_dark":
      return {
        ...
        tips: [
          ...
          "You can practice this check anytime in Settings → Camera check",
        ],
      };
    case "blocked_blurry":
      return {
