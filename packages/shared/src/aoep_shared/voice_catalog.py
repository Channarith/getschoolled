...
VOICE_CATALOG: List[Voice] = [
    ...
    Voice("en_us_south_m", "Southern US — Davis (M)", "en", "en-US", "Southern US", "male", "en-US-DavisNeural", dialect="us_south"),
    Voice("en_us_south_f", "Southern US — Jenny (F)", "en", "en-US", "Southern US", "female", "en-US-JennyNeural", dialect="us_south"),
    Voice("en_us_ny_m", "New York — Guy (M)", "en", "en-US", "New York", "male", "en-US-GuyNeural", dialect="us_ny"),
    Voice("en_us_ny_f", "New York — Aria (F)", "en", "en-US", "New York", "female", "en-US-AriaNeural", dialect="us_ny"),
    Voice("en_us_ne_f", "New England — Jenny (F)", "en", "en-US", "New England", "female", "en-US-JennyNeural", dialect="us_ne"),
    ...
    Voice("en_ie_f", "Irish — Emily (F)", "en", "en-IE", "Irish", "female", "en-IE-EmilyNeural", dialect="en_ie"),
    Voice("en_in_f", "Indian — Neerja (F)", "en", "en-IN", "Indian", "female", "en-IN-NeerjaNeural", dialect="en_in"),
    Voice("en_in_m", "Indian — Prabhat (M)", "en", "en-IN", "Indian", "male", "en-IN-PrabhatNeural", dialect="en_in"),
    Voice("en_ca_f", "Canadian — Clara (F)", "en", "en-CA", "Canadian", "female", "en-CA-ClaraNeural", dialect="en_ca"),
    Voice("en_sg_f", "Singaporean — Sonia (F)", "en", "en-GB", "Singaporean", "female", "en-GB-SoniaNeural", dialect="en_sg"),
    Voice("en_za_f", "South African — Leah (F)", "en", "en-ZA", "South African", "female", "en-ZA-LeahNeural", dialect="en_za"),
    # --- Spanish --------------------------------------------------------- #
    ...
    # --- Chinese (Beijing / Shanghai / Cantonese / Fujian overlays) ------ #
    Voice("zh_bj_f", "Chinese (Beijing) — Xiaoxiao (F)", "zh", "zh-CN", "Beijing Mandarin", "female", "zh-CN-XiaoxiaoNeural", dialect="zh_bj"),
    Voice("zh_bj_m", "Chinese (Beijing) — Yunxi (M)", "zh", "zh-CN", "Beijing Mandarin", "male", "zh-CN-YunxiNeural", dialect="zh_bj"),
    Voice("zh_sh_f", "Chinese (Shanghai) — Xiaoyi (F)", "zh", "zh-CN", "Shanghainese", "female", "zh-CN-XiaoyiNeural", dialect="zh_sh"),
    Voice("zh_yue_gz_f", "Chinese (Guangzhou Cantonese) — HiuMaan (F)", "zh", "zh-HK", "Cantonese (Guangzhou/HK)", "female", "zh-HK-HiuMaanNeural", dialect="zh_yue_gz"),
    Voice("zh_yue_gz_m", "Chinese (Guangzhou Cantonese) — WanLung (M)", "zh", "zh-HK", "Cantonese (Guangzhou/HK)", "male", "zh-HK-WanLungNeural", dialect="zh_yue_gz"),
    Voice("zh_min_fj_f", "Chinese (Fujian/Hokkien) — HsiaoChen (F)", "zh", "zh-TW", "Fujianese / Hokkien", "female", "zh-TW-HsiaoChenNeural", dialect="zh_min_fj"),
    Voice("zh_cn_f", "Chinese (Mandarin) — Xiaoxiao (F)", "zh", "zh-CN", "Mandarin (China)", "female", "zh-CN-XiaoxiaoNeural", dialect="zh_bj"),
    Voice("zh_cn_m", "Chinese (Mandarin) — Yunxi (M)", "zh", "zh-CN", "Mandarin (China)", "male", "zh-CN-YunxiNeural", dialect="zh_bj"),
    Voice("zh_hk_f", "Chinese (Cantonese) — HiuMaan (F)", "zh", "zh-HK", "Cantonese (HK)", "female", "zh-HK-HiuMaanNeural", dialect="zh_yue_gz"),
