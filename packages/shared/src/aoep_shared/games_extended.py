...
_EXTENDED_RAW: List[dict] = [
    ...
    # --- Biology supplemental (marathon depth) ------------------------------- #
    {
        "content_id": "bio_ext_01", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "What do red blood cells carry around the body?",
        "options": ["Oxygen", "Glucose", "Carbon dioxide", "Water"],
        "answer_index": 0,
        "explain": "Haemoglobin in red blood cells binds and transports oxygen.",
        "kind": "mcq",
    },
    {
        "content_id": "bio_ext_02", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "Which organ produces insulin?",
        "options": ["Liver", "Kidney", "Pancreas", "Stomach"],
        "answer_index": 2,
        "explain": "Beta cells in the pancreas secrete insulin to regulate blood sugar.",
        "kind": "mcq",
    },
    {
        "content_id": "bio_ext_03", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "What type of molecule is DNA?",
        "options": ["Lipid", "Carbohydrate", "Protein", "Nucleic acid"],
        "answer_index": 3,
        "explain": "DNA is a nucleic acid polymer made of nucleotides.",
        "kind": "mcq",
    },
    {
        "content_id": "bio_ext_04", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "What process do plants use to make food from sunlight?",
        "options": ["Respiration", "Fermentation", "Photosynthesis", "Digestion"],
        "answer_index": 2,
        "explain": "Photosynthesis converts light, CO₂ and water into glucose and oxygen.",
        "kind": "mcq",
    },
    {
        "content_id": "bio_ext_05", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "Which part of the cell controls its activities?",
        "options": ["Cell wall", "Nucleus", "Mitochondria", "Ribosome"],
        "answer_index": 1,
        "explain": "The nucleus contains DNA and directs cell functions.",
        "kind": "mcq",
    },
    {
        "content_id": "bio_ext_06", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "What is the powerhouse of the cell?",
        "options": ["Nucleus", "Ribosome", "Mitochondria", "Golgi apparatus"],
        "answer_index": 2,
        "explain": "Mitochondria produce ATP through cellular respiration.",
        "kind": "mcq",
    },
    {
        "content_id": "bio_ext_07", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "Which blood type is the universal donor?",
        "options": ["A", "B", "AB", "O"],
        "answer_index": 3,
        "explain": "Type O negative has no A, B, or Rh antigens, so it can be given to anyone.",
        "kind": "mcq",
    },
    {
        "content_id": "bio_ext_08", "subjects": ["biology"], "game_types": ["mcq", "marathon"],
        "prompt": "How many chromosomes do humans typically have?",
        "options": ["23", "44", "46", "48"],
        "answer_index": 2,
        "explain": "Humans have 46 chromosomes in 23 pairs.",
        "kind": "mcq",
    },
    ...
    # --- Shape Drop (Tetris-style geometry) --------------------------------- #
    {
        "content_id": "shape_01", "subjects": ["geometry", "math"], "game_types": ["shape_drop", "geometry"],
        "prompt": "A tetromino I-piece is a straight bar. How many unit squares?",
        "options": ["3", "4", "5", "6"], "answer_index": 1,
        "explain": "Every tetromino has exactly four squares.",
        "meta": {"piece": "I", "style": "tetris"},
        "kind": "shape_drop",
    },
    {
        "content_id": "shape_02", "subjects": ["geometry", "math"], "game_types": ["shape_drop", "geometry"],
        "prompt": "Rotate a square 90°. What changes?",
        "options": ["Nothing — it looks the same", "It becomes a triangle", "It loses a side", "Area doubles"],
        "answer_index": 0,
        "explain": "A square has 4-fold rotational symmetry.",
        "meta": {"piece": "O", "style": "tetris"},
        "kind": "shape_drop",
    },
    {
        "content_id": "shape_03", "subjects": ["geometry"], "game_types": ["shape_drop", "geometry"],
        "prompt": "An L-tetromino covers how many right angles at its corner bend?",
        "options": ["1", "2", "3", "4"], "answer_index": 0,
        "explain": "The L bend forms one interior right angle.",
        "meta": {"piece": "L", "style": "tetris"},
        "kind": "shape_drop",
    },
    {
        "content_id": "shape_04", "subjects": ["geometry", "math"], "game_types": ["shape_drop"],
        "prompt": "Which shape tiles the plane with no gaps (like Tetris clears)?",
        "options": ["Squares", "Regular pentagons alone", "Circles", "Hearts"],
        "answer_index": 0,
        "explain": "Squares tessellate perfectly — that's why grid clears work.",
        "meta": {"concept": "tessellation"},
        "kind": "shape_drop",
    },
    {
        "content_id": "shape_05", "subjects": ["geometry", "math"], "game_types": ["shape_drop", "geometry"],
        "prompt": "Perimeter of a 2×2 square (unit cells)?",
        "options": ["4", "6", "8", "16"], "answer_index": 2,
        "explain": "Four sides × 2 units = 8.",
        "meta": {"piece": "O"},
        "kind": "shape_drop",
    },
    {
        "content_id": "shape_06", "subjects": ["geometry"], "game_types": ["shape_drop"],
        "prompt": "A T-piece tip points down. Rotate 180°. Where does the tip point?",
        "options": ["Up", "Down", "Left", "Right"], "answer_index": 0,
        "explain": "180° flip reverses the tip direction.",
        "meta": {"piece": "T", "style": "tetris"},
        "kind": "shape_drop",
    },
    {
        "content_id": "shape_07", "subjects": ["geometry", "math"], "game_types": ["shape_drop", "geometry"],
        "prompt": "Sum of interior angles in a triangle?",
        "options": ["90°", "180°", "270°", "360°"], "answer_index": 1,
        "explain": "Every triangle's angles add to 180°.",
        "kind": "shape_drop",
    },
    {
        "content_id": "shape_08", "subjects": ["geometry"], "game_types": ["shape_drop"],
        "prompt": "S and Z tetrominoes are…",
        "options": ["Mirror images (reflections)", "Identical without rotating", "Circles", "Pentominoes"],
        "answer_index": 0,
        "explain": "S and Z are reflections of each other.",
        "meta": {"piece": "S"},
        "kind": "shape_drop",
    },
    # --- Stock Market Lab --------------------------------------------------- #
    {
        "content_id": "stock_01", "subjects": ["finance"], "game_types": ["stocks", "quiz"],
        "prompt": "A 'bull market' means prices are generally…",
        "options": ["Rising", "Falling", "Frozen", "Illegal"], "answer_index": 0,
        "explain": "Bulls charge up — a bull market is rising prices.",
        "meta": {"topic": "markets"},
        "kind": "stocks",
    },
    {
        "content_id": "stock_02", "subjects": ["finance"], "game_types": ["stocks"],
        "prompt": "A 'bear market' means prices are generally…",
        "options": ["Falling", "Rising", "Only for gold", "Always illegal"], "answer_index": 0,
        "explain": "Bears swipe down — a bear market is falling prices.",
        "meta": {"topic": "markets"},
        "kind": "stocks",
    },
    {
        "content_id": "stock_03", "subjects": ["finance", "life_growth"], "game_types": ["stocks", "resource"],
        "prompt": "Best beginner habit for investing?",
        "options": ["Diversify across many assets", "Put everything in one stock", "Ignore all news forever", "Only trade on tips from strangers"],
        "answer_index": 0,
        "explain": "Diversification reduces the impact of any single failure.",
        "kind": "stocks",
    },
    {
        "content_id": "stock_04", "subjects": ["finance"], "game_types": ["stocks"],
        "prompt": "You buy a stock at $10 and sell at $12. Your profit per share (before fees) is…",
        "options": ["$2", "$10", "$12", "$22"], "answer_index": 0,
        "explain": "Profit = sell price − buy price = $2.",
        "meta": {"topic": "returns"},
        "kind": "stocks",
    },
    {
        "content_id": "stock_05", "subjects": ["finance"], "game_types": ["stocks", "quiz"],
        "prompt": "What does 'dividend' usually mean?",
        "options": ["Cash a company pays shareholders", "A loan you must repay", "A trading fee", "A stock split only"],
        "answer_index": 0,
        "explain": "Dividends share company profits with owners.",
        "kind": "stocks",
    },
    {
        "content_id": "stock_06", "subjects": ["finance", "math"], "game_types": ["stocks"],
        "prompt": "Portfolio: $60 stocks + $40 bonds. Stock % is…",
        "options": ["60%", "40%", "100%", "24%"], "answer_index": 0,
        "explain": "60 / 100 = 60% in stocks.",
        "kind": "stocks",
    },
    {
        "content_id": "stock_07", "subjects": ["finance"], "game_types": ["stocks"],
        "prompt": "Higher expected return usually comes with…",
        "options": ["Higher risk", "Zero risk", "Guaranteed profit", "No homework"],
        "answer_index": 0,
        "explain": "Risk and return typically move together.",
        "kind": "stocks",
    },
    {
        "content_id": "stock_08", "subjects": ["finance", "life_growth"], "game_types": ["stocks", "rpg"],
        "prompt": "Friend tips a hot stock. Smart first move?",
        "options": ["Research before buying anything", "Buy all you can immediately", "Sell your house", "Ignore investing forever"],
        "answer_index": 0,
        "explain": "Do your own research — tips are not homework.",
        "kind": "stocks",
    },
    {
        "content_id": "stock_09", "subjects": ["finance"], "game_types": ["stocks"],
        "prompt": "An index fund typically…",
        "options": ["Tracks a market basket of stocks", "Picks only one company", "Is illegal for beginners", "Guarantees 50% returns"],
        "answer_index": 0,
        "explain": "Index funds hold a broad market slice for diversification.",
        "kind": "stocks",
    },
    {
        "content_id": "stock_10", "subjects": ["finance"], "game_types": ["stocks"],
        "prompt": "If you need the money next month, parking it in volatile stocks is…",
        "options": ["Usually a bad idea", "The safest choice", "Required by law", "Always free money"],
        "answer_index": 0,
        "explain": "Short-term needs belong in safer cash-like places.",
        "kind": "stocks",
    },
    # --- Professional workplace scenarios (What would you do?) ---------------- #
    {
        "content_id": "wp_comp_01", "subjects": ["workplace"], "game_types": ["scenario", "rpg"],
        "prompt": "Scenario: A vendor offers $800 event tickets. What would you do?",
        "options": ["Accept — relationship building", "Check gifts policy before accepting", "Accept secretly", "Give tickets to family"],
        "answer_index": 1,
        "explain": "High-value gifts often violate policy. Check before accepting.",
        "meta": {"track": "compliance", "scene": "vendor meeting", "policy": "Gifts & entertainment"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_comp_02", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: An agent demands a 'facilitation payment' to release customs. What would you do?",
        "options": ["Pay cash to avoid delay", "Refuse and escalate to compliance/legal", "Have a colleague pay", "Ignore"],
        "answer_index": 1,
        "explain": "May violate anti-bribery laws. Never pay — escalate immediately.",
        "meta": {"track": "compliance", "scene": "international shipping", "policy": "Anti-bribery"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_safe_01", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Pallets block an emergency exit in the warehouse. What would you do?",
        "options": ["Leave it", "Clear if safe and report to safety", "Use it anyway", "Wait for audit"],
        "answer_index": 1,
        "explain": "Blocked exits are life-safety violations. Clear and report now.",
        "meta": {"track": "safety", "scene": "warehouse", "policy": "Fire / OSHA"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_safe_02", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Chemical solvent spilled; strong smell, no injuries yet. What would you do?",
        "options": ["Mop quietly alone", "Alert others, ventilate, use spill kit, notify supervisor", "Ignore it", "Trash in regular bin"],
        "answer_index": 1,
        "explain": "Follow SDS/spill procedures. Ventilate, contain, notify.",
        "meta": {"track": "safety", "scene": "lab", "policy": "Chemical safety"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_priv_01", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Patient schedule visible on a hallway screen. What would you do?",
        "options": ["Read names", "Ask staff to lock screen / reposition", "Take a photo", "Ignore"],
        "answer_index": 1,
        "explain": "PHI must not be exposed. Prompt privacy controls.",
        "meta": {"track": "privacy", "scene": "clinic", "policy": "HIPAA"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_priv_02", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Colleague emails a spreadsheet with employee SSNs. What would you do?",
        "options": ["Reply-all with fix", "Use secure channel; minimize SSN use", "Forward to personal email", "Delete only"],
        "answer_index": 1,
        "explain": "SSNs are sensitive PII. Secure tools and data minimization.",
        "meta": {"track": "privacy", "scene": "office", "policy": "Data privacy"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_eth_01", "subjects": ["workplace"], "game_types": ["scenario", "rpg"],
        "prompt": "Scenario: Manager makes repeated unwelcome comments; coworker looks uncomfortable. What would you do?",
        "options": ["Ignore", "Support colleague if safe; report via HR/ethics", "Post on social media", "Laugh along"],
        "answer_index": 1,
        "explain": "Document facts and use official reporting channels.",
        "meta": {"track": "ethics", "scene": "office", "policy": "Harassment prevention"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_eth_02", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Supervisor asks you to backdate a safety log before audit. What would you do?",
        "options": ["Do it — boss said so", "Refuse and report via ethics/compliance", "Backdate some entries", "Quit silently"],
        "answer_index": 1,
        "explain": "Falsifying records is fraud. Refuse and escalate.",
        "meta": {"track": "ethics", "scene": "audit prep", "policy": "Workplace ethics"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_sec_01", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Urgent email with unfamiliar link asks for your password. What would you do?",
        "options": ["Click and reset", "Report phishing; use official portal only", "Forward link to everyone", "Reply to verify"],
        "answer_index": 1,
        "explain": "Report phishing. Never enter credentials on suspicious links.",
        "meta": {"track": "security", "scene": "email", "policy": "Security awareness"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_sec_02", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Stranger without badge follows you through secure door. What would you do?",
        "options": ["Hold door — be polite", "Require badge or escort to reception", "Let them in if dressed well", "Ignore"],
        "answer_index": 1,
        "explain": "Tailgating defeats physical security. Badge or visitor process.",
        "meta": {"track": "security", "scene": "secure facility", "policy": "Physical security"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_trade_01", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Foreign customer wants technical drawings emailed tonight. What would you do?",
        "options": ["Send now to close deal", "Verify export classification/licenses first", "Send blurry photos", "Let customer classify"],
        "answer_index": 1,
        "explain": "Technical data may need export authorization.",
        "meta": {"track": "trade", "scene": "sales", "policy": "Export control"},
        "kind": "scenario",
    },
    {
        "content_id": "wp_trade_02", "subjects": ["workplace"], "game_types": ["scenario"],
        "prompt": "Scenario: Prospect from a sanctioned country requests pricing. What would you do?",
        "options": ["Quote fast", "Stop; consult trade compliance before proceeding", "Ship via third country", "Ignore"],
        "answer_index": 1,
        "explain": "Sanctions violations carry severe penalties. Compliance must screen.",
        "meta": {"track": "trade", "scene": "international sales", "policy": "Trade compliance"},
        "kind": "scenario",
    },
]
