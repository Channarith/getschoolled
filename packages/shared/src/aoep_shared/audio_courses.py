...
_TOPICS: Dict[str, List[str]] = {
    ...
    "Music Production": [
        "Digital Audio Workstations", "Mixing and Mastering Basics",
        "Recording Techniques", "Sound Design Fundamentals",
        "Beats and Rhythm Programming", "Synthesis Explained",
        "Audio Effects (EQ, Compression, Reverb)", "Sampling and Loops",
        "Music Distribution and Licensing", "Home Studio Setup",
        "Podcasting Production", "Voiceover and Narration",
    ],
    "Film & Television Production": [
        "Pre-Production Planning", "Camera Operation Basics",
        "Lighting for Video", "Sound Recording for Film",
        "Video Editing Fundamentals", "Color Grading Basics",
        "Post-Production Workflow", "Screenplay Formatting",
        "Directing Actors", "Film Budgeting",
        "Distribution and Film Festivals", "YouTube and Social Video",
    ],
    "Graphic Design": [
        "Design Principles Explained", "Typography Fundamentals",
        "Color Theory and Palettes", "Logo Design Basics",
        "Print vs Digital Design", "Adobe Photoshop Overview",
        "Adobe Illustrator Basics", "Canva for Business",
        "Branding Identity Design", "Infographic Design",
        "Poster and Flyer Design", "Social Media Graphics",
    ],
    "Photography": [
        "Camera Basics and Settings", "Composition Rules",
        "Portrait Photography", "Landscape Photography",
        "Product Photography", "Street Photography",
        "Lighting Techniques", "Photo Editing in Lightroom",
        "Black and White Photography", "Event Photography",
        "Building a Photography Portfolio", "Photography Business Basics",
    ],
    "Fashion & Style": [
        "Fashion History Overview", "Understanding Body Types and Dressing",
        "Color Coordination", "Building a Capsule Wardrobe",
        "Sustainable Fashion", "Fashion Week and Trends",
        "Fabric and Textile Basics", "Vintage and Thrift Shopping",
        "Men's Style Fundamentals", "Professional Dress Codes",
        "Personal Shopping and Styling", "Fashion Business and Marketing",
    ],
    "Travel & Hospitality": [
        "Travel Planning Basics", "Budget Travel Tips",
        "Solo Travel Safety", "Traveling With Family",
        "Business Travel Etiquette", "Hotel and Accommodation Choices",
        "Travel Insurance Explained", "Understanding Visas and Passports",
        "Cultural Etiquette for Travelers", "Travel Photography Tips",
        "Cruise Travel Guide", "Ecotourism and Responsible Travel",
    ],
    "Agriculture & Farming": [
        "Sustainable Farming Basics", "Organic Farming Methods",
        "Crop Rotation and Soil Health", "Livestock Management",
        "Precision Agriculture Technology", "Aquaponics and Hydroponics",
        "Farm Business Management", "Food Systems and Supply Chains",
        "Beekeeping Basics", "Urban Farming and Community Gardens",
        "Water Management in Agriculture", "AgriTech Innovation",
    ],
    "Maritime & Boating": [
        "Boating Safety Fundamentals", "Navigation Basics",
        "Weather for Mariners", "Rules of the Road (COLREGS)",
        "VHF Radio Communication", "Knots and Lines",
        "Anchoring Techniques", "Marine Engines Basics",
        "Sailing Fundamentals", "Emergency Procedures at Sea",
        "Coastal vs Offshore Navigation", "Maritime Law Overview",
    ],
    "Aviation": [
        "Private Pilot Basics", "How Airplanes Fly (Aerodynamics)",
        "Aviation Weather", "Air Traffic Control Explained",
        "Navigation for Pilots", "Aviation Regulations (FAR/AIM)",
        "Aircraft Systems Overview", "Crew Resource Management",
        "Drone Operation Basics", "Airport Operations",
        "Aviation Career Paths", "Flight Planning",
    ],
    "Religion & Spirituality": [
        "World Religions Overview", "The History of Christianity",
    ...
    "Astronomy & Space Science": [
        "The Solar System in Depth", "Life Cycle of Stars",
        "Galaxies and Nebulae", "Black Holes and Neutron Stars",
        "Cosmology and the Big Bang", "Exoplanet Research",
        "Space Telescopes and Observatories", "Human Spaceflight History",
        "Mars Exploration", "Asteroid and Comet Science",
        "Radio Astronomy", "SETI and the Search for Life",
    ],
    "Gaming & Esports": [
        "History of Video Games", "Game Design Fundamentals",
        "Esports Industry Overview", "Professional Gaming Career Paths",
        "Game Streaming and Content Creation", "Game Development Basics",
        "Storytelling in Games", "Competitive Gaming Strategy",
        "Gaming and Mental Health", "Mobile Gaming Industry",
        "Retro Gaming and Nostalgia", "Virtual Reality Gaming",
    ],
    "Human Resources": [
        "HR Fundamentals", "Recruiting and Talent Acquisition",
        "Onboarding Best Practices", "Performance Management",
        "Employee Relations and Conflict Resolution", "Compensation and Benefits",
        "Learning and Development Programs", "HR Analytics",
        "Employment Law Overview", "Succession Planning",
        "Remote Team Management", "HR Technology and HRIS",
    ],
    "Supply Chain & Logistics": [
        "Supply Chain Fundamentals", "Inventory Management",
        "Warehouse Operations", "Transportation and Freight",
        "Procurement and Sourcing", "Demand Forecasting",
        "Supply Chain Technology", "Last-Mile Delivery",
        "Global Trade and Customs", "Cold Chain Logistics",
        "Reverse Logistics and Returns", "Supply Chain Disruption and Resilience",
    ],
    "Data Engineering": [
        "Data Pipelines Explained", "ETL vs ELT Processes",
        "SQL for Data Engineers", "Apache Spark Basics",
        "Data Warehousing Concepts", "Cloud Data Platforms",
        "Data Modeling Fundamentals", "Stream Processing",
        "Data Quality and Governance", "Data Lakehouse Architecture",
        "Orchestration with Airflow", "Data Engineering Career Path",
    ],
    "Cybersecurity Advanced": [
        "Penetration Testing Basics", "Network Security Architecture",
        "Cloud Security Fundamentals", "Identity and Access Management",
        "Incident Response Procedures", "Threat Intelligence",
        "Security Operations Center (SOC)", "Malware Analysis",
        "Zero Trust Security Model", "Cryptography Fundamentals",
        "Security Compliance Frameworks", "Bug Bounty Programs",
    ],
    "Mental Health Professionals": [
        "Introduction to Counseling", "Cognitive Behavioral Therapy Basics",
        "Motivational Interviewing", "Trauma-Informed Care",
        "Substance Use Disorders Overview", "Group Therapy Facilitation",
        "Ethics in Mental Health Practice", "Documentation and Treatment Plans",
        "Crisis Intervention", "Cultural Competence in Counseling",
        "Telehealth for Mental Health", "Self-Care for Helpers",
    ],
    ...
    "Public Health": [
        "Epidemiology Basics", "Global Health Challenges",
        "Vaccination and Herd Immunity", "Health Equity and Disparities",
        "Chronic Disease Prevention", "Environmental Health",
        "Maternal and Child Health", "Mental Health in Communities",
        "Public Health Data and Surveillance", "Emergency Preparedness",
        "Health Literacy", "Public Health Policy",
    ],
    ...
    "Economics": [
        "Microeconomics Fundamentals", "Macroeconomics Overview",
        "Supply and Demand", "Inflation and Monetary Policy",
        "International Trade", "Labor Markets and Employment",
        "Behavioral Economics", "Environmental Economics",
        "Development Economics", "Economic Inequality",
        "Fiscal Policy and Government Spending", "History of Economic Thought",
    ],
    "Philosophy": [
